...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-9.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jan 2023 17:12:08 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
  ...
  <title>Dutta Tours and Travels</title>
</head>
...
<body>
  <div class="preloader js-preloader">
    ...
    <div class="preloader__title">Dutta Travels</div>
  </div>
          ...
          <div class="col-auto">
            <div class="row x-gap-15 y-gap-15 items-center">
              <div class="col-auto md:d-none">
                <a href="#" class="text-12 text-white">+(91) 86177 68021</a>
              </div>
              ...
              <div class="col-auto">
                <a href="#" class="text-12 text-white">duttatourtravels9@gmail.com</a>
              </div>
            </div>
          </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="masthead__bg bg-dark-3">
              <img src="{{ asset('frontend/img/banner/adventure-trips-xplorene.jpg')}}" alt="image">
            </div>
              ...
              <div class="row justify-center">
                <div class="col-xl-9">
                  <div class="text-center">
                    ...
                    <h1 class="text-80 lg:text-60 sm:text-40 text-white">Adventure India</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="masthead__bg bg-dark-3">
              <img src="{{asset('frontend/img/banner/cultural-india.jpg')}}" alt="image">
            </div>
            ...
            <div class="container">
              <div class="row justify-center">
                <div class="col-xl-9">
                  <div class="text-center">
                    <div class="text-white fw-500 uppercase mb-10">TOUR EXPERIENCE</div>
                    <h1 class="text-80 lg:text-60 sm:text-40 text-white">Culture India</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="masthead__bg bg-dark-3">
              <img src="{{asset('frontend/img/banner/wild-life-banner-xplorene.jpg')}}" alt="image">
            </div>
            ...
            <div class="container">
              <div class="row justify-center">
                <div class="col-xl-9">
                  <div class="text-center">
                    <div class="text-white fw-500 uppercase mb-10">TOUR EXPERIENCE</div>
                    <h1 class="text-80 lg:text-60 sm:text-40 text-white">Wild Life India</h1>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div data-anim-child="slide-up delay-1" class="row y-gap-20 justify-center text-center">
          <div class="col-auto">
            <div class="sectionTitle -md">
              ...
              <p class=" sectionTitle__text mt-5 sm:mt-0">Choose your Place</p>
            </div>
          </div>
        </div>
        ...
        <div class="row x-gap-10 y-gap-10 pt-40 sm:pt-20">
          ...
          <div data-anim-child="slide-up delay-2" class="col-xl col-lg-3 col-6">
            <a href="#" class="citiesCard -type-5 d-flex items-center sm:flex-column sm:items-start px-20 py-20 sm:px-15 sm:py-20 bg-light-2 rounded-4">
              ...
              <div class="ml-10 sm:ml-0 sm:mt-10">
                <h4 class="text-16 fw-500">West</h4>
              </div>
            </a>
          </div>
          ...
          <div data-anim-child="slide-up delay-3" class="col-xl col-lg-3 col-6">
            <a href="#" class="citiesCard -type-5 d-flex items-center sm:flex-column sm:items-start px-20 py-20 sm:px-15 sm:py-20 bg-light-2 rounded-4">
              ...
              <div class="ml-10 sm:ml-0 sm:mt-10">
                <h4 class="text-16 fw-500">South West</h4>
              </div>
            </a>
          </div>
          ...
          <div data-anim-child="slide-up delay-4" class="col-xl col-lg-3 col-6">
            <a href="#" class="citiesCard -type-5 d-flex items-center sm:flex-column sm:items-start px-20 py-20 sm:px-15 sm:py-20 bg-light-2 rounded-4">
              ...
              <div class="ml-10 sm:ml-0 sm:mt-10">
                <h4 class="text-16 fw-500">South</h4>
              </div>
            </a>
          </div>
          ...
          <div data-anim-child="slide-up delay-5" class="col-xl col-lg-3 col-6">
            <a href="#" class="citiesCard -type-5 d-flex items-center sm:flex-column sm:items-start px-20 py-20 sm:px-15 sm:py-20 bg-light-2 rounded-4">
              ...
              <div class="ml-10 sm:ml-0 sm:mt-10">
                <h4 class="text-16 fw-500">Sikkim</h4>
              </div>
            </a>
          </div>
          ...
          <div data-anim-child="slide-up delay-6" class="col-xl col-lg-3 col-6">
            <a href="#" class="citiesCard -type-5 d-flex items-center sm:flex-column sm:items-start px-20 py-20 sm:px-15 sm:py-20 bg-light-2 rounded-4">
              ...
              <div class="ml-10 sm:ml-0 sm:mt-10">
                <h4 class="text-16 fw-500">Rajasthan</h4>
              </div>
            </a>
          </div>
          ...
          <div data-anim-child="slide-up delay-7" class="col-xl col-lg-3 col-6">
            <a href="#" class="citiesCard -type-5 d-flex items-center sm:flex-column sm:items-start px-20 py-20 sm:px-15 sm:py-20 bg-light-2 rounded-4">
              ...
              <div class="ml-10 sm:ml-0 sm:mt-10">
                <h4 class="text-16 fw-500">Northeast</h4>
              </div>
            </a>
          </div>
          ...
          <div data-anim-child="slide-up delay-8" class="col-xl col-lg-3 col-6">
            <a href="#" class="citiesCard -type-5 d-flex items-center sm:flex-column sm:items-start px-20 py-20 sm:px-15 sm:py-20 bg-light-2 rounded-4">
              ...
              <div class="ml-10 sm:ml-0 sm:mt-10">
                <h4 class="text-16 fw-500">Nepal</h4>
              </div>
            </a>
          </div>
    ...
    <section class="layout-pt-md layout-pb-lg">
      <div data-anim-wrap class="container">
        <div data-anim-child="slide-up delay-1" class="row y-gap-20 justify-center text-center">
          <div class="col-auto">
            <div class="sectionTitle -md">
              <h2 class="sectionTitle__title">We Provide Various</h2>
              <p class=" sectionTitle__text mt-5 sm:mt-0">Types Of Tours</p>
            </div>
          </div>
        </div>
              ...
              <div class="cruiseCard__image">
                ...
                <div class="cardImage ratio ratio-6:5">
                  <div class="cardImage__content">
                    ...
                    <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{asset('frontend/img/tours/heritage.jpg')}}" alt="image">
              ...
              <div class="cruiseCard__image">
                ...
                <div class="cardImage ratio ratio-6:5">
                  <div class="cardImage__content">
                    ...
                    <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{asset('frontend/img/tours/adventure.jpg')}}" alt="image">
              ...
              <div class="cruiseCard__image">
                ...
                <div class="cardImage ratio ratio-6:5">
                  <div class="cardImage__content">
                    ...
                    <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{asset('frontend/img/tours/himalaya.jpg')}}" alt="image">
              ...
              <div class="cruiseCard__image">
                ...
                <div class="cardImage ratio ratio-6:5">
                  <div class="cardImage__content">
                    ...
                    <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{asset('frontend/img/tours/honeymoon.jpg')}}" alt="image">
      ...
      <div class="container lg:mt-30">
        <div class="row">
          <div class="offset-xl-6 col-xl-5 col-lg-6">
            <h2 class="text-30 fw-600">THERE ARE VAST STILL TO UNRAVEL, TRAVEL AND EXPLORE THEM</h2>
            <p class="text-dark-1 mt-40 lg:mt-20 sm:mt-15">The journey of a thousand miles begins with a single step; take the 1st step with us; the rest we will manage. Dutta Tours and Travels helps you to explore every mile with ease and grace. We are empowered with local learned guides to make our job easy.</p>
          ...
          <div class="row y-gap-40 justify-between xl:justify-start">
            <div class="col-xl-2 col-lg-4 col-sm-6">
              ...
              <div class="mt-30">
                ...
                <a href="#" class="text-18 fw-500 mt-5">+(91) 86177 68021</a><br>
                <a href="#" class="text-18 fw-500 mt-5">+(91) 79803 33900</a><br>
                <a href="#" class="text-18 fw-500 mt-5">+(91) 74395 88546</a>
              </div>

              <div class="mt-35">
                <div class="text-14 mt-30">Need live support?</div>
                <a href="#" class="text-18 fw-500 mt-5">duttatourtravels9@gmail.com</a>
              </div>
            </div>

            <div class="col-xl-2 col-lg-4 col-sm-6">
              <h5 class="text-16 fw-500 mb-30">Top Destination</h5>
              ...
              <div class="row y-gap-10 items-center">
                <div class="col-auto">
                  <div class="d-flex x-gap-20 items-center">
                    <a href="https://www.facebook.com/profile.php?id=100089845206020"><i class="icon-facebook text-14"></i></a>
                    <a href="https://www.instagram.com/duttatourtravels/"><i class="icon-instagram text-14"></i></a>
                  </div>
                </div>
              </div>
            </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-9.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jan 2023 17:12:11 GMT -->
</html>
